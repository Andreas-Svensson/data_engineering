...
with DAG(dag_id = "joke_DAG", start_date = datetime(2023, 6, 1)):
    say_hello = BashOperator(task_id = "say_hello", bash_command = 'echo "hello hello"')
    ...
    say_hello >> setup_folders >> download_joke # overloaded bitshift operator to signify dependence, say_hello is upstream, setup_folder is downstream
